...
int
Token_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
Token_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Token_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Token_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Token_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Token_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Token_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Token_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Token_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static const ber_tlv_tag_t asn_DEF_Token_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (26 << 2))
};
asn_TYPE_descriptor_t asn_DEF_Token = {
	"Token",
	"Token",
	Token_free,
	Token_print,
	...
	asn_DEF_Token_tags_1,
	sizeof(asn_DEF_Token_tags_1)
		/sizeof(asn_DEF_Token_tags_1[0]), /* 1 */
	asn_DEF_Token_tags_1,	/* Same as above */
	sizeof(asn_DEF_Token_tags_1)
		/sizeof(asn_DEF_Token_tags_1[0]), /* 1 */
