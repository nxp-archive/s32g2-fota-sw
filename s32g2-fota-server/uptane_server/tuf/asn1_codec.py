...
def convert_signed_metadata_to_der(
  ...
  for pydict_sig in pydict_signatures:
    ...
    asn_sig['keyid'] = metadata_asn1_spec.Keyid(hexValue=pydict_sig['keyid']).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ...
    asn_sig['value'] = metadata_asn1_spec.OctetString(
        hexValue=pydict_sig['sig']).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
