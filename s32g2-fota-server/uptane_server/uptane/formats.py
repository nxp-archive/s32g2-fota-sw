...
STATE_SCHEMA = SCHEMA.ListOf(SCHEMA.OneOf(
  [SCHEMA.String('kunregistered'), SCHEMA.String('kPresent'),
   SCHEMA.String('kAdded'), SCHEMA.String('kUpdated'),
   SCHEMA.String('kRemoved')]))
...
ECU_VERSION_MANIFEST_SCHEMA = SCHEMA.Object(
    ...
    #installedImage = SCHEMA.AnyString(),
    #state = STATE_SCHEMA,
    
    ) # was expired metadata previously detected?
